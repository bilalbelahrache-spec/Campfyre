...
-keep class com.bilal.campfire.Campfire { *; }
-keep class com.bilal.campfire.client.CampfireClient { *; }

# Same story for Mixin: every class here is referenced by exact name from
# campfire.mixins.json / campfire.client.mixins.json, and Mixin's own
...
-keep class com.bilal.campfire.mixin.** { *; }
-keep class com.bilal.campfire.client.mixin.** { *; }
