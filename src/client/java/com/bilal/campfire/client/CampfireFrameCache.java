...
// CampfireClient's. A tiny, exact 1-in-1,000,000-per-real-second chance
...
public final class CampfireFrameCache {
    ...
    private CampfireFrameCache() {
    }

    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(CampfireFrameCache::tick);
    }
